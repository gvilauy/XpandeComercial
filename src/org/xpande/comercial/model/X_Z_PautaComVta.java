...
public class X_Z_PautaComVta extends PO implements I_Z_PautaComVta, I_Persistent 
{
    ...
    public X_Z_PautaComVta (Properties ctx, int Z_PautaComVta_ID, String trxName)
    {
      super (ctx, Z_PautaComVta_ID, trxName);
      /** if (Z_PautaComVta_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_Z_PautaComVta (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_PautaComVta[")
	...
	public void setZ_PautaComVta_ID (int Z_PautaComVta_ID)
	{
		if (Z_PautaComVta_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_PautaComVta_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_PautaComVta_ID, Integer.valueOf(Z_PautaComVta_ID));
	}
