...
// N
    ...
    /** Load Constructor */
    public X_Z_ReservaVta (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_ReservaVta[")
	...
	public void setZ_ReservaVta_ID (int Z_ReservaVta_ID)
	{
		if (Z_ReservaVta_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_ReservaVta_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_ReservaVta_ID, Integer.valueOf(Z_ReservaVta_ID));
	}
