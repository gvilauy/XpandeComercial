...
/** Generated Model for Z_SubfamiliaProd
 *  @author Adempiere (generated) 
 *  @version Release 3.9.1 - $Id$ */
public class X_Z_SubfamiliaProd extends PO implements I_Z_SubfamiliaProd, I_Persistent 
{
    ...
    public X_Z_SubfamiliaProd (Properties ctx, int Z_SubfamiliaProd_ID, String trxName)
    {
      super (ctx, Z_SubfamiliaProd_ID, trxName);
      /** if (Z_SubfamiliaProd_ID == 0)
        {
			setName (null);
			setZ_FamiliaProd_ID (0);
			setZ_SubfamiliaProd_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_SubfamiliaProd (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_SubfamiliaProd[")
	...
	public void setZ_SubfamiliaProd_ID (int Z_SubfamiliaProd_ID)
	{
		if (Z_SubfamiliaProd_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_SubfamiliaProd_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_SubfamiliaProd_ID, Integer.valueOf(Z_SubfamiliaProd_ID));
	}
