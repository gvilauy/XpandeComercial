...
public class X_Z_OrdenDevolucion extends PO implements I_Z_OrdenDevolucion, I_Persistent 
{
    ...
    {
      super (ctx, Z_OrdenDevolucion_ID, trxName);
      /** if (Z_OrdenDevolucion_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_Z_OrdenDevolucion (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_OrdenDevolucion[")
	...
	public void setZ_OrdenDevolucion_ID (int Z_OrdenDevolucion_ID)
	{
		if (Z_OrdenDevolucion_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_OrdenDevolucion_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_OrdenDevolucion_ID, Integer.valueOf(Z_OrdenDevolucion_ID));
	}
